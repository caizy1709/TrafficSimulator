...
var laneRoadworks =
  [ //题目说要determine ... following the toll,所以只更改右侧shape,size
    // [
    //   [0,6,7], beginUR - 9 * lenRoadworkElement
    // ],
    [
      [7], beginUR - 8 * lenRoadworkElement
    ],
    [
      [0,7], beginUR - 7 * lenRoadworkElement
    ],
    [
      [0,7], beginUR - 6 * lenRoadworkElement
    ],
    [
      [0,6,7], beginUR - 5 * lenRoadworkElement
    ],
    [
      [0,6,7], beginUR - 4 * lenRoadworkElement
    ],
    [
    ...
    [
      [0,1,5,6,7], beginUR - 1 * lenRoadworkElement
    ],
    //下面全是路障，保证四车道
    [
